...
namespace CodedUITestProject4
{
    ...
    public partial class UIMap
    {
        ...
        public void LogInTest()
        {
            ...
            Mouse.Click(uIPasswordEdit, new Point(245, 17));
        ...
        /// <summary>
        /// Checks if user properly logged in
        /// </summary>
        public void LogInCheck()
        {
            ...
            Assert.AreEqual(this.LogInChechExpectedValues.UIBrowseBooksEditName, uIBrowseBooksEdit.Name, "Login failed");
        }
        ...
        public virtual LogInChechExpectedValues LogInChechExpectedValues
        {
            get
            {
                if ((this.mLogInChechExpectedValues == null))
                {
                    this.mLogInChechExpectedValues = new LogInChechExpectedValues();
                }
                return this.mLogInChechExpectedValues;
            }
        }
        ...
        private LogInChechExpectedValues mLogInChechExpectedValues;
    ...
    /// <summary>
    /// Parameters to be passed into 'LogInChech'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.21005.1")]
    public class LogInChechExpectedValues
    {
